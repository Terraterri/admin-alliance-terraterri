...
const OnGoingExpo = () => {
  ...
  const fetchOngoingExpos = async () => {
    try {
      ...
      toastError('Failed to fetch ongoing expos');
      console.error(err);
    } finally {
      setLoading(false);
    }
                ...
                <div className="page-title-box d-flex align-items-center justify-content-between">
                  <div className="page-title-right">
                    <ol className="breadcrumb m-0">
                      ...
                      <li className="breadcrumb-item active">Ongoing Expo</li>
                    </ol>
                  </div>
                </div>
              </div>
                      ...
                      <table className="table text-nowrap mb-0">
                        ...
                        <tbody>
                          {filteredData.length > 0 ? (
                            ...
                            <tr>
                              <td colSpan="8" className="text-center">No ongoing expos found</td>
                            </tr>
                          )}
                        </tbody>
                      </table>
